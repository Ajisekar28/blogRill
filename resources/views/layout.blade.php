	    ...
	    <div class="container">
	        ...
	        <div class="collapse navbar-collapse text-center" id="navbarsExample09">
	            <ul class="navbar-nav ml-auto">
	                ...
	                <li class="nav-item"><a class="nav-link" href="{{ route('blog.category', 'education') }}">Education</a></li>
	                <li class="nav-item"><a class="nav-link" href="{{ route('blog.category', 'job') }}">Job</a></li>
	                <li class="nav-item"><a class="nav-link" href="{{ route('blog.category', 'lifestyle') }}">Lifestyle</a></li>
	                <li class="nav-item"><a class="nav-link" href="{{ route('blog.category', 'technology') }}">Technology</a></li>
